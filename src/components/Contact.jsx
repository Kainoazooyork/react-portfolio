function Contact() {
    ...
    return (
        <>
            <section>
                <h2>Contact Me</h2>
                <div className="w3-container w3-content w3-padding-64" style={{maxWidth: 800}} id="contact">
  ...
  <div className="w3-row w3-padding-32">
    <div className="w3-col m6 w3-large w3-margin-bottom">
      <i className="fa fa-map-marker" style={{width: 30}} /> Seattle, US<br />
     
      <i className="fa fa-envelope" style={{width: 30}}> </i> Email: Kainoazooyork@outlook.com<br />
    </div>
